...
public class CredentialController {
    ...
    public String getHomePage(
        ...
        populateModelWithCredentials(authentication, model);
        return "home";
    }
    ...
    // New method to populate model with credentials
    private void populateModelWithCredentials(Authentication authentication, Model model) {
        String userName = authentication.getName();
    ...
    // New method to generate encoded key
